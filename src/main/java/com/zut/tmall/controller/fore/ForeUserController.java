...
import com.zut.tmall.entity.Address;
import com.zut.tmall.entity.User;
import com.zut.tmall.service.AddressService;
import com.zut.tmall.service.UserService;
...
public class ForeUserController extends BaseController{
    ...
    public  String uploadUserHeadImage(@RequestParam MultipartFile file, HttpSession session
        ...
        String filePath = session.getServletContext().getRealPath("/") + "E:\\javajdk\\IDEADOMO\\Tmall_demo-master\\Tmall_demo-master\\src\\main\\webapp\\res\\images\\item\\userProfilePicture" + fileName;
