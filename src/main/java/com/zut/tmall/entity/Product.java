...
public class Product {
    ...
    public Product(Integer product_id, String product_name, String product_title, Double product_price, Double product_sale_price, Date product_create_date, Category product_category, Byte product_isEnabled, List<PropertyValue> propertyValueList, List<ProductImage> singleProductImageList, List<ProductImage> detailProductImageList,  List<ProductOrderItem> productOrderItemList,Integer product_sale_count) {
        this.product_id = product_id;
        this.product_name = product_name;
