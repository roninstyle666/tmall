...
<%--                        <div class="site-hot">--%>
<%--&lt;%&ndash;                            <h2>热点推荐<span>Hot</span></h2>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">天猫超市</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">喵鲜生</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">科技新品</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">女装新品</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">酷玩街</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">内衣新品</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">试美妆</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">运动新品</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">时尚先生</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">精明妈咪</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">吃乐会</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">企业采购</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">会员积分</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">天猫国际</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <li><a href="">品质频道</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </ul>&ndash;%&gt;--%>
<%--                        </div>--%>
